export const tasks = [
  {
    ...
    label: 'documentation',
    priority: 'medium',
    description: 'This task involves working with compression algorithms and open-source SSD pixel management.',
    assignedTo: 'John Doe',
  },
  {
    id: 'TASK-7878',
    ...
    label: 'documentation',
    priority: 'medium',
    description: 'Research and analysis needed for EXE feed calculation methodology.',
  },
  {
    id: 'TASK-7839',
    ...
    label: 'bug',
    priority: 'high',
    description: 'Critical bug affecting neural TCP card functionality.',
  },
  {
    id: 'TASK-5562',
    ...
    label: 'feature',
    priority: 'medium',
    description: 'Investigation required for SAS interface issues.',
  },
  {
    id: 'TASK-8686',
    ...
    label: 'feature',
    priority: 'medium',
    description: 'Completed wireless SSL protocol parsing implementation.',
    llmData: {
      retrospectiveNotes: 'Task completed successfully with minimal issues.',
      llmSummary: 'SSL protocol parsing was implemented using standard encryption libraries.',
    },
  },
  {
    id: 'TASK-1280',
    ...
    label: 'bug',
    priority: 'high',
    description: 'Digital TLS panel integration with haptic system.',
    llmData: {
      retrospectiveNotes: 'High priority bug fixed ahead of schedule.',
      llmSummary: 'TLS panel configuration was updated to support haptic transmission.',
    },
  },
  {
    id: 'TASK-7262',
    ...
    label: 'feature',
    priority: 'high',
    description: 'UTF8 application restoration and neural bandwidth parsing.',
  },
  {
    id: 'TASK-1138',
    ...
    label: 'feature',
    priority: 'medium',
    description: 'SMTP bandwidth quantification for high-resolution displays.',
  ...
  },
  {
    ...
    label: 'feature',
    priority: 'low',
    description: 'Back-end THX pixel programming requirements assessment.',
  },
  {
    id: 'TASK-5160',
    ...
    label: 'documentation',
    priority: 'high',
    description: 'JSON protocol navigation implementation in progress.',
    comments: ['Initial implementation completed', 'Needs performance optimization'],
  },
  {
    id: 'TASK-5618',
    ...
    label: 'documentation',
    priority: 'medium',
    description: 'SSL application indexing documentation completed.',
  },
  {
    id: 'TASK-6699',
    ...
    label: 'documentation',
    priority: 'medium',
    description: 'Research wireless JBOD capacitor transmission methods.',
  },
  {
    id: 'TASK-2858',
    ...
    label: 'bug',
    priority: 'medium',
    description: 'Investigation of UDP bus override requirements.',
  },
  {
    id: 'TASK-9864',
    ...
    label: 'bug',
    priority: 'high',
    description: 'FTP panel reboot process for HEX hard drive matrix.',
  },
  {
    id: 'TASK-8404',
    ...
    label: 'bug',
    priority: 'low',
    description: 'Virtual HEX alarm generation improvements.',
  },
]
  {
    id: 'TASK-5365',
